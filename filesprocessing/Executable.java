...
/**
 * This class represents a filter which filters which are defined as executable.
 */
public class Executable extends Filter {
    File directory;
    String yesOrNo;
    /**
     * Constructs a new Executable filter object.
     ...
     */
    public Executable(File directory, String yesOrNo){
